...
(if (not (bound-and-true-p spacemacs-module-path))
    (setq spacemacs-module-path "~/.doom.d/modules/"))
...
(load! (concat spacemacs-module-path "spacemacs/core/core-funcs.el"))
(load! (concat spacemacs-module-path "spacemacs/core/core-load-paths.el"))
(load! (concat spacemacs-module-path "spacemacs/core/core-dotspacemacs.el"))
(load! (concat spacemacs-module-path "spacemacs/core/core-spacemacs-buffer.el"))
(load! (concat spacemacs-module-path "spacemacs/core/core-fonts-support.el"))
(load! (concat spacemacs-module-path "spacemacs/core/core-themes-support.el"))
;; (load! (concat spacemacs-module-path "spacemacs/core/core-dumper.el")
(load! (concat spacemacs-module-path "spacemacs/core/core-keybindings.el"))
(load! (concat spacemacs-module-path "spacemacs/core/core-transient-state.el"))
(load! (concat spacemacs-module-path "spacemacs/core/core-toggle.el"))
(load! (concat spacemacs-module-path "spacemacs/core/core-use-package-ext.el"))
(load! (concat spacemacs-module-path "spacemacs/core/core-versions.el"))
(load! (concat spacemacs-module-path "spacemacs/core/core-progress-bar.el"))
(load! (concat spacemacs-module-path "spacemacs/core/core-configuration-layer.el"))
;; (load! (concat spacemacs-module-path "spacemacs/core/core-hooks.el")
;; (load! (concat spacemacs-module-path "spacemacs/core/core-fonts-support.el"))
...
;; ;; org layer
;; (load! (concat spacemacs-module-path "spacemacs/layer/org/packages.el"))
;; (org/init-org)
;; ;; (org/post-init-org)
;; (org/init-org-agenda)
;; (org/init-org-brain)
...
;; ;; pdf layer
;; (load! (concat spacemacs-module-path "spacemacs/layer/pdf/packages.el"))
;; (pdf/init-pdf-tools)

;; ;; epub layer
;; (load! (concat spacemacs-module-path "spacemacs/layer/epub/packages.el"))
;; (epub/init-nov)

;; ;; dash layer
;; (load! (concat spacemacs-module-path "spacemacs/layer/dash/packages.el"))
;; ;; (load! (concat spacemacs-module-path "spacemacs/layer/dash/config.el"))
;; ;; (load! (concat spacemacs-module-path "spacemacs/layer/dash/funcs.el"))
...
(load! (concat spacemacs-module-path "spacemacs/layer/spacemacs-defaults/funcs.el"))
(load! (concat spacemacs-module-path "spacemacs/layer/spacemacs-defaults/keybindings.el"))
...
(load! (concat spacemacs-module-path "spacemacs/layer/evil-evilified-state/evil-evilified-state.el"))
(load! (concat spacemacs-module-path "spacemacs/layer/version-control/packages.el"))
(load! (concat spacemacs-module-path "spacemacs/layer/version-control/keybindings.el"))
(load! (concat spacemacs-module-path "spacemacs/layer/version-control/funcs.el"))
(load! (concat spacemacs-module-path "spacemacs/layer/version-control/config.el"))
...
;; ;; github layer
;; (load! (concat spacemacs-module-path "spacemacs/layer/github/funcs.el"))
;; (load! (concat spacemacs-module-path "spacemacs/layer/github/packages.el"))
;; (github/init-forge)
;; (github/init-gist)
...
(load! (concat spacemacs-module-path "spacemacs/layer/spacemacs-navigation/funcs.el"))
(load! (concat spacemacs-module-path "spacemacs/layer/spacemacs-navigation/packages.el"))
(spacemacs-navigation/init-auto-highlight-symbol)
(spacemacs-navigation/init-symbol-overlay)


;; ;; spacemacs layouts layer
;; (load! (concat spacemacs-module-path "spacemacs/layer/spacemacs-layouts/packages.el"))
;; (load! (concat spacemacs-module-path "spacemacs/layer/spacemacs-layouts/funcs.el"))
;; (load! (concat spacemacs-module-path "spacemacs/layer/spacemacs-layouts/config.el"))
;; (spacemacs-layouts/init-eyebrowse)
;; (spacemacs-layouts/init-persp-mode)


;; bm layer
;; (load! (concat spacemacs-module-path "spacemacs/layer/bm/packages.el"))
;; (bm/init-bm)

;; git layer
;; (load! (concat spacemacs-module-path "spacemacs/layer/git/packages.el"))
;; (git/init-git-timemachine)

;; ;; javascript layer
;; (load! (concat spacemacs-module-path "spacemacs/layer/javascript/packages.el"))
;; (load! (concat spacemacs-module-path "spacemacs/layer/javascript/config.el"))
;; (load! (concat spacemacs-module-path "spacemacs/layer/javascript/funcs.el"))
...
(load! (concat spacemacs-module-path "spacemacs/layer/spacemacs-editing/packages.el"))
...
(load! (concat spacemacs-module-path "spacemacs/layer/spacemacs-evil/config.el"))
(load! (concat spacemacs-module-path "spacemacs/layer/spacemacs-evil/funcs.el"))
(load! (concat spacemacs-module-path "spacemacs/layer/spacemacs-evil/packages.el"))
...
;; ;; shell layer
;; (load! (concat spacemacs-module-path "spacemacs/layer/shell/config.el"))
;; (load! (concat spacemacs-module-path "spacemacs/layer/shell/funcs.el"))
;; (load! (concat spacemacs-module-path "spacemacs/layer/shell/packages.el"))
;; ;; (shell/init-eshell)
;; (shell/init-vterm)


;; colors layer
(load! (concat spacemacs-module-path "spacemacs/layer/spacemacs-colors/config.el"))
(load! (concat spacemacs-module-path "spacemacs/layer/spacemacs-colors/funcs.el"))
(load! (concat spacemacs-module-path "spacemacs/layer/spacemacs-colors/packages.el"))
(colors/init-color-identifiers-mode)
(colors/init-rainbow-identifiers)
(setq colors-colorize-identifiers 'all)

;; ;; json layer
;; (load! (concat spacemacs-module-path "spacemacs/layer/json/config.el"))
;; (load! (concat spacemacs-module-path "spacemacs/layer/json/funcs.el"))
;; (load! (concat spacemacs-module-path "spacemacs/layer/json/packages.el"))
...
;; ;; spacemacs ivy completion layer
(load! (concat spacemacs-module-path "spacemacs/layer/spacemacs-completion-ivy/config.el"))
(load! (concat spacemacs-module-path "spacemacs/layer/spacemacs-completion-ivy/funcs.el"))
;; (load! (concat spacemacs-module-path "spacemacs/layer/spacemacs-completion-ivy/packages.el"))
;; (ivy/pre-init-auto-highlight-symbol)
